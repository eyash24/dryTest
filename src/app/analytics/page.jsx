...
//           <h2 className="text-2xl font-bold text-gray-800 mb-6">Question Analysis & Learning Support</h2>
...
//                       <h5 className="font-semibold text-green-800 mb-2">📖 Study Preparation</h5>
//                       <p className="text-green-700 text-sm">{feedback.preparation}</p>
//                     </div> */}
//                   </div>
//                 </div>
...
//                   <h5 className="font-semibold text-blue-800 mb-2">🎯 Targeted Study Tips</h5>
//                   <ul className="text-blue-700 text-sm space-y-1">
//                     <li>• Spend extra time understanding why option {question.correctAnswer} is correct</li>
//                     <li>• Practice similar questions from your textbook</li>
//                     <li>• Discuss this topic with your teacher or study group</li>
//                     <li>• Use online resources and educational videos for better understanding</li>
//                   </ul>
//                 </div> */}
//               </div>
//             );
...
//                 recommendations: "Complete analytics generated"
//               };
//               const blob = new Blob([JSON.stringify(analyticsData, null, 2)], {type: 'application/json'});
//               const url = URL.createObjectURL(blob);
//               const a = document.createElement('a');
//               a.href = url;
//               a.download = `${quizData.topic}_analytics.json`;
//               a.click();
//             }}
